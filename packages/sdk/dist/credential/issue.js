...
import { bytesToBase64Url, bytesToHex, sortedClaimKeys, } from "../utils/encoding.js";
import { ISSUER, PROOF_TYPE, VC_CONTEXT, } from "./schema.js";
const DEFAULT_TTL_MS = 1000 * 60 * 60 * 24 * 365 * 2;
export async function issueCredential(userId, claims, signingKey, publicKeyId, options = {}) {
    ...
    const expirationDate = new Date(now.getTime() + (options.ttlMs ?? DEFAULT_TTL_MS)).toISOString();
    const credential = {
        "@context": [...VC_CONTEXT],
