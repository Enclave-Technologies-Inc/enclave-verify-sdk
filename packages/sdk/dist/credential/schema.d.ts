export type ClaimKey = "identity_verified" | "age_18_plus" | "age_21_plus" | "name_verified" | "nationality" | "document_type";
export type ClaimSet = Record<string, string | boolean>;
export declare const VC_CONTEXT: readonly ["https://www.w3.org/ns/credentials/v2", "https://verify.enclave.talk/contexts/v1"];
export declare const PROOF_TYPE: "MLDSASignature2024";
export declare const ISSUER: "verify.enclave.talk";
